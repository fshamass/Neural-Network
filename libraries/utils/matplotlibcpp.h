...
//F static_assert(sizeof(long long) == 8);
//F template <> struct select_npy_type<long long> { const static NPY_TYPES type = NPY_INT64; };
//F static_assert(sizeof(unsigned long long) == 8);
//F template <> struct select_npy_type<unsigned long long> { const static NPY_TYPES type = NPY_UINT64; };
