...
public:
    ...
    DataHandler::dataPtrVector& getAllData() override;
    DataHandler::dataPtrVector& getTrainData() override;
    DataHandler::dataPtrVector& getTestData() override;
    DataHandler::dataPtrVector& getValidData() override;
...
private:
    ...
    DataHandler::dataPtrVector dataStore_;
    DataHandler::dataPtrVector trainingData_;
    DataHandler::dataPtrVector testData_;
    DataHandler::dataPtrVector validationData_;
