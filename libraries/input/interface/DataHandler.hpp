...
public:
    ...
    using dataPtrVector = std::vector<std::shared_ptr<DataHandler::Data>>;
    ...
    virtual DataHandler::dataPtrVector& getAllData() = 0;
    virtual DataHandler::dataPtrVector& getTrainData() = 0;
    virtual DataHandler::dataPtrVector& getTestData() = 0;
    virtual DataHandler::dataPtrVector& getValidData() = 0;
protected:
    DataHandler();
    ~DataHandler();
private:
